...
export const metadata: Metadata = {
  title: "Ayuda",
  description: "Cómo comprar, envíos y estados de carta en Win Condition TCG.",
};
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Los perfiles de vendedor los crea el administrador de Win Condition TCG. Escríbenos y habilitamos tu cuenta para publicar singles, sellados y mazos.",
  },
];
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="mt-2 text-[14px] text-ink-400">
        Todo lo que necesitas saber para comprar y vender en Win Condition TCG.
      </p>
